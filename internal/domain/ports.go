...
// ---- Incoming (primary/driving) ports ---------------------------------------

// GitEventHandler is the primary port the NATS ingest adapter calls into for
// Git events.
...
// CicdEventHandler is the primary port the NATS ingest adapter calls into for
...
// PlatformEventHandler is the primary port for platform config events.
